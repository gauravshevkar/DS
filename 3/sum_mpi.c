...
// 1. mpicc sum_mpi.c -o sum_mpi
// 2. mpirun -np 4 ./sum_mpi
...
// If installed, output something like:

// /usr/bin/mpicc
// If MPI is NOT installed in Linux

// Then Ubuntu/Debian me install command:
